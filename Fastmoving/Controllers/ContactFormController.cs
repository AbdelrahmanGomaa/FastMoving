...
using Fastmoving.Models;


namespace Fastmoving.Controllers
{
    public class ContactFormController : SurfaceController
    {
        ...
        public async Task<IActionResult> SubmitAsync(ContactFormViewModel model)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                var parentId = Guid.Parse("75885d6a-47d2-48f6-86cf-33e0c44da3e1");
                ...
                var from = "fastmovingeg@gmail.com";
                var to = "fastmovingeg@gmail.com";
