...
var Agency = function(){
	...
	var fileInput = function(){
		...
		jQuery(document).on('change', '.btn-file :file', function() {
			...
			var	label = input.val().replace(/\\/g, 'https://agency.dexignzone.com/').replace(/.*\//, '');
